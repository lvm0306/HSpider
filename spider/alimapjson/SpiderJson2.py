...
def download(code, filefold, name):
    ...
    print('正在下载' + 'https://geo.datav.aliyun.com/areas_v3/bound/' + code + '_full.json')
    html = SpiderHtml('https://geo.datav.aliyun.com/areas_v3/bound/' + code + '_full.json').getHtmlWithReferer(
        'https://geo.datav.aliyun.com/')

    with open(filefold + '\\' + name + '_full.json', "w") as file:  #
        file.write(html)
